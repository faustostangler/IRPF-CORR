...
def process_brokerage_notes(notes: List[BrokerageNote], ticker_map: Optional[Dict[str, str]] = None) -> Dict[str, Position]:
    """
    ...
    for note in sorted_notes:
        ...
        for trade in apportioned_trades:
            ...
            current_position = portfolio.get(mapped_ticker, Position(ticker=mapped_ticker, quantity=0, average_cost="0.0000"))
